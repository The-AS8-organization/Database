"""
Django settings for ProgramNexus project.
...
ROOT_URLCONF = 'ProgramNexus.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_TEMPLATE_DIR, CORE_TEMPLATE_DIR, RESOURCE_TEMPLATE_DIR],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ProgramNexus.wsgi.application'
